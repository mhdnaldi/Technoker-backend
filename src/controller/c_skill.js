...
const { postSkill, deleteSkill, getWorkerSkills, checkWorkerSkill } = require("../model/m_skill");
    ...
    postSkill: async (request, response) => {
        ...
        try {
            ...
            if (checkId.length > 0) {
                ...
                return helper.response(response, 400, `Worker with ID ${user_id} is not Found!`);
            }
        } catch (error) {
